...
@given(
    ...
    xD=st.integers(min_value=MIN_XD, max_value=MAX_XD),
    yD=st.integers(min_value=MIN_XD, max_value=MAX_XD),
    zD=st.integers(min_value=MIN_XD, max_value=MAX_XD),
